...
void insertToMap(unordered_map <string, Variable*> map) {
    ...
    Variable *slip_skid_ball_indicated_slip_skid = new Variable("/instrumentation/slip-skid-ball/indicated-slip-skid");
    map["slip_skid_ball_indicated_slip_skid"] = slip_skid_ball_indicated_slip_skid;
    Variable *turn_indicator_indicated_turn_rate = new Variable("/instrumentation/turn-indicator/indicated-turn-rate");
